...
exports.getPokemonData = (dexNo, params = {gen: 6}) => parseForGen(params.gen, tryRequire(`./data/pokemon/${dexNo}`, `Invalid dex number: ${dexNo}`));
exports.getItemData = (itemId, params = {gen: 6}) => itemId ? parseForGen(params.gen, tryRequire(`./data/item/${itemId}`, `Invalid item ID: ${itemId}`)) : null;
exports.getMoveData = (moveId, params = {gen: 6}) => moveId ? parseForGen(params.gen, tryRequire(`./data/move/${moveId}`, `Invalid move ID: ${moveId}`)) : null;
exports.getAbilityData = (abilId, params = {gen: 6}) => abilId ? parseForGen(params.gen, tryRequire(`./data/ability/${abilId}`, `Invalid ability ID: ${abilId}`)) : null;
